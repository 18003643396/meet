...
(function () {
	...
	var URL = window.UEDITOR_HOME_URL || '/rsc/js/ueditor4longpost/';//修改路径
	var URL2 = 'http://l.bst.126.net/rsc/js/ueditor4longpost/';//静态化路径
	...
	UEDITOR_CONFIG = {
        ...
        toolbars:[
                   ['Undo','Redo','|','Bold','Italic','Underline','|','Paragraph','InsertUnorderedList','InsertOrderedList','Horizontal','BlockQuote','|','Link','Unlink','InsertImage','Source','FullScreen']
        ],
        //当鼠标放在工具栏上时显示的tooltip提示
        labelMap:{
        	'link':'插入链接','insertimage':'插入图片'
        },
        /*
        labelMap:{
        	'undo':'撤销', 'redo':'重做', 'bold':'加粗','italic':'斜体','underline':'下划线','insertunorderedlist':'无序列表','insertorderedlist':'有序列表','blockquote':'引用','link':'插入链接','unlink':'取消链接','insertimage':'插入图片','source':'源码','fullscreen':'全屏'
        },
        */
        //dialog内容的路径 ～会被替换成URL
        iframeUrlMap:{
            'anchor':'~/dialogs/anchor/anchor.html',
            'insertimage':'~/dialogs/image/loftimage.html',
            ...
            'insertvideo':'~/dialogs/video/loftvideo.html',
        ...
        listMap:{
            ...
            //段落格式 值:显示的名字
            'paragraph':['p:正文', 'h1:H1', 'h2:H2', 'h3:H3', 'h4:H4'],
            //段间距 值和显示的名字相同
        ...
        iframeCssUrl:'http://l.bst.126.net/rsc/js/ueditor4longpost/themes/loftskin/iframe.css?037', //要引入css的url
        ...
        highlightJsUrl:URL2 + "third-party/SyntaxHighlighter/shCore.js",
        highlightCssUrl:URL2 + "third-party/SyntaxHighlighter/shCoreDefault.css",
        codeMirrorJsUrl:URL2 + "third-party/codemirror2.15/codemirror.js",
        codeMirrorCssUrl:URL2 + "third-party/codemirror2.15/codemirror.css",
        ...
        serialize:function () {                              //配置过滤标签
        	return {
        		...
        		whiteList:{
        			        'h1':{'$':{},'a':1,'span':1,'u':1,'b':1,'strong':1,'strike':1},
        			        'h2':{'$':{},'a':1,'span':1,'u':1,'b':1,'strong':1,'strike':1},
        			        'h3':{'$':{},'a':1,'span':1,'u':1,'b':1,'strong':1,'strike':1},
        			        'h4':{'$':{},'a':1,'span':1,'u':1,'b':1,'strong':1,'strike':1},
        			        'hr':{'$':{}},
        			        ...
        			        'source':{'$':{'type':1,'src':1}},
        			        'video':{'$':{'id':1,'class':1,'poster':1,'controls':1,'data-setup':1,'x-webkit-airplay':1,'webkit-playsinline':1},'source':1},
        			        'p': {'$':{'reblogfrom':1},'div':1,'p':1,'a':1,'span':1,'ul':1,'ol':1,'li':1,'embed':1,'object':1,'br':1,'BR':1,'u':1,'b':1,'strong':1,'strike':1,'img':1,'blockquote':1,'video':1},
        		            ...
        		            'img':{'$':{'src':1,'smallsrc':1,'localvideo':1,'webvideo':1,'video-data':1,'style':1}},
        ...
        autotypeset:{
            ...
            pasteFilter : false,             //根据规则过滤没事粘贴进来的内容 //此标志似乎是反的
