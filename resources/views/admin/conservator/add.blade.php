   ...
   @section('content')
    ...
    <div class="content-wrapper"style='margin-left:20px'>
        ...
        <div class="box box-primary">
            ...
            @endif
            <form action="/admin/conservator"method="post"id="myform"enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        <div class="form-group"style="margin-left:50px">
                            ...
                            <tr>
                                ...
                                <td>
                                    <label><input class="common-text required"  name="status" value="1" type="radio"checked>&nbsp;开启</label>
                                    <label><input class="common-text required"  name="status" value="0" type="radio">&nbsp;禁用</label>
                                </td>
                            </tr>
