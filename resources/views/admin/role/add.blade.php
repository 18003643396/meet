   ...
   @section('content')
    ...
    <div class="content-wrapper"style='margin-left:10px'>
        ...
        <div class="box box-primary">
            ...
            @endif
            <form action="/admin/role"method="post"id="myform"enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        <div class="form-group"style="margin-left:50px">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="title" name="role_name" size="16" value="" type="text">
                                </td>
                            </tr>
