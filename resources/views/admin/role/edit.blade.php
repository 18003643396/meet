   ...
   @section('content')
    ...
    <div class="content-wrapper"style='margin-left:20px'>
        ...
        <div class="box box-primary">
            ...
            <form action="/admin/role/{{$res->id}}"method="post"id="myform"enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        <div class="form-group"style="margin-left:50px">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="title" name="role_name" size="20" value="{{$res->role_name}}" type="text">
                                </td>
                            </tr>
