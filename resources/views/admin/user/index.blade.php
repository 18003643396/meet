								...
								<tr>
									...
									<td>
										<select name="search" id="">
											...
											<option value="sex"@if($search == "sex") selected @endif}>性别</option>
										</select>
									</td>
            ...
            <div class="box-body table-responsive no-padding">
				<table class="table table-hover">
					...
					<tr>
						...
						<td>
							<a href="/admin/user/{{$v->id}}/edit"class='btn btn-block btn-default btn-xs'style='width: 50px;'><i class='fa fa-pencil-square-o'></i></a>&nbsp;
...
<script>
	...
	$('.name').dblclick(function(){
		...
		ipu.blur(function(){
			...
			//获取id
				...
				$.get('/admin/userajax',{uv:uv,ids:ids},function(data){
	...
	$('#alldelete').click(function(){
			...
			if(confirm("确定要删除所选项目？")) { 
				...
				$.get('/admin/userdeleteajax',{ids:checkedList.toString()},function(data){
						console.log(data);
						if(data == 1){
							 alert("删除成功");
						}else{
